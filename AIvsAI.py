...
Zeus = Snake("Zeus", 5, 2)
Hades = Snake("Hades", 5, 4)
Poseidon = Snake("Poseidon", 5, 6)
Typhon = Snake("Typhon", 5, 8)

snakes = [Zeus, Hades, Poseidon, Typhon]
snake_render_dict = {"Zeus":{"head": "g", "tail": "G"},
                     "Hades":{"head": "M", "tail": "m"},
                     "Poseidon":{"head": "R", "tail": "r"},
                     "Typhon":{"head": "U", "tail": "u"}}
snake_points = {}
